...
Among the Bee SoCs, the SDHC controller is present only on rtl87x2g.
...
Feature List
~~~~~~~~~~~~
- A single host controller, ``sdhc0``.
...
.. code-block:: console
   ...
   *** Booting Zephyr OS build ... ***
   ...
   Testing writes of 31 sectors
    PASS - test_write in 0.143 seconds
   ===================================================================
   TESTSUITE disk_driver succeeded

   ------ TESTSUITE SUMMARY START ------

   SUITE PASS - 100.00% [disk_driver]: pass = 2, fail = 0, skip = 0, total = 2
    - PASS - [disk_driver.test_read] duration = 0.034 seconds
    - PASS - [disk_driver.test_write] duration = 0.143 seconds
